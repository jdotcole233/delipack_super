 ...
 <head>
  ...
  <body>
            ...
            <div class="d-none d-lg-block col-lg-4">
              <div class="slider-light">
                <div class="slick-slider">
                  <div>
                    ...
                    >
                      ...
                      <div class="slider-content">
                        ...
                        <p>
                          KeroUI is like a dream. Some think it's too good to be
                  ...
                  <div>
                    <div
                      class="h-100 d-none justify-content-center align-items-center bg-premium-dark"
                      tabindex="-1"
                    >
                      <div
                        class="slide-img-bg"
                  ...
                  <div>
                    <div
                      class="h-100 d-none justify-content-center align-items-center bg-sunny-morning"
                      tabindex="-1"
                    >
                      <div
                        class="slide-img-bg"
    ...
    <script
      ...
      src="/main.07a59de7b920cd76b874.js"
    ></script>
  </body>
</html>
